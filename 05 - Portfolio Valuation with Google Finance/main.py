...
def display_portfolio_summary(portfolio):
    ...
    print(tabulate(position_data, headers=['Ticker', 'Exchange', 'Quantity',
          'Price', 'Market Value', '% Allocation'], tablefmt='psql', floatfmt=".2f"))
...
if __name__ == "__main__":
    ...
    portfolio = Portfolio([Position(shop, 10), Position(
        msft, 2), Position(googl, 30)])
